...
<body>
   ...
   <?php include('include/header.php'); ?>
                ...
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            ...
                            <h3 class="heading pb-2">VALUE SERVERS PACKAGES</h3>
                            <p class="text-justify mt-4">Grab a great deal on our branded servers before the stock gets exhausted.<br>
                            You can use these servers for hosting websites, database servers and application servers.<br>

                            Our promise of highest uptime and superfast connectivity in our Tier 4 datacenters will ensure <br>that your applications are always on so will be your business.</p>
    ...
    <!--        <li class="breadcrumb-item">Value Server</li>-->
    <!--      </ol>-->
    <!--    </nav>-->
    <!--</section>-->
        ...
        <div class="container">
                 <div class="row">
                    <div class="col-md-9">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                            <h4 style="color: #021058"> VALUE SERVERS PACKAGES</h4>
                            </div>
                        </div>
                        <!-- table -->
                            <table class="table table-responsive table-bordered">
                              ...
                              <tbody>
                                <tr>
                                   ...
                                   <td>Quad core 3430</td>
                                   <td>Quad core 1220</td>
                                   <td>Quad core 5410/5506/07</td>
                                   <td>2X Quad core 5620/5506</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <th style="color: #6fc572">Disk space
                                   ...
                                   <td>2 X 1TB HDD</td>
                                   <td>2 X 2 TB HDD</td>
                                   <td>2 X 900GB SAS, 1 X 1 TB SATA</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                   ...
                                   <td>
                                    ...
                                    <img src="img\png\linux.png" title="Linux LOGO" align="absmiddle">
                                    <input type="radio" value="4700(Windows)">
                                    <img src="img\png\microsoft.png" title="Cloud OS" align="absmiddle">
                                    </td>
                                   <td>
                                    <input type="radio" value="4110(Linux)" name="radio">
                                    <img src="img\png\linux.png" title="Linux LOGO" align="absmiddle">
                                    <input type="radio" value="4700(Windows)">
                                    <img src="img\png\microsoft.png" title="Cloud OS" align="absmiddle">
                                   </td>
                                   ...
                                   <td><input type="radio" value="4110(Linux)" name="radio">
                                    <img src="img\png\linux.png" title="Linux LOGO" align="absmiddle">
                                    <input type="radio" value="4700(Windows)">
                                    <img src="img\png\microsoft.png" title="Cloud OS" align="absmiddle">
                                   </td>
                                 ...
                                 <tr>
                                    <td></td>
                                  <td>
                                    <a href="#" type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal">
                                      BUY & DEPLOY
                                    </a>
                                   </td>
                                    <td>
                        ...
                        <!-- //table -->
                        <div class="row"style="border: 1px solid #152653;
    border-radius: 5px;background-color:#e9f6fc">
                            <div class="col-md-5">
                                <p style="border-right: 1px dotted">Click to explore our other service offering</p>
                            </div>
                            <div class="col-md-3">
                                <p style="border-right: 1px dotted">Cloud Server</p>
                            </div>
                            <div class="col-md-4">
                                <p>US Server</p>
                            </div>
                    ...
                    <!-- end reasons -->
                        ...
                        <div class="color-box" style="border: solid 1px #152653;">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12" style="height: 357px;">
                                    <ul class="list-group">
                                        <li class="list-group-item">Windows VPS
                                        <span>Windows based Virtual Private Servers</span></li>
                                      <li class="list-group-item">Managed VPS<span>VPS with L1, L2 and L3 Managed Services</span></li>
                                      <li class="list-group-item">Managed VPS<span>VPS with L1, L2 and L3 Managed Services</span></li>
                                      <li class="list-group-item">Hosters VPS<span>VPS with Control Panels</span></li> 
                                    </ul>
                                </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-header bg-info">
                                      <h4 class="modal-title">BUY & DEPLOY</h4>
                                    ...
                                    <div class="modal-body">
                                      <div id="form-div">
                                        ...
                                        <input type="text" style="display:none;" name="returnURL" value="https://www.ctrls.com/thankyou.php"> 
                                              ...
                                              <div class="form-group row">
                                                <label class="col-sm-4 col-form-label">Business Email<span style="color:red;">*</span></label>
                                              ...
                                              <div class="form-group row">
                                                <label class="col-sm-4 col-form-label pr-0">Company</label>
                                                <div class="col-sm-8">
                                                    <input type="text" maxlength="80" name="Company" class="form-control textbox">
                                                  <!--<textarea name="Description" rows="3" maxlength="32000" class="form-control textbox">&nbsp;</textarea>-->
                                                </div>
                                              </div>
                                              
                                               <div class="form-group row">
                                                <label class="col-sm-4 col-form-label pr-0">Job Tiitle</label>
                                                <div class="col-sm-8">
                                                    <input type="text" maxlength="80" name="Company" class="form-control textbox">
                                                </div>
                                              </div>
                                               ...
                                               <div class="form-group row">
                                                <label class="col-sm-4 col-form-label pr-0">Country</label>
                                                <div class="col-sm-8">
                                                    <input type="text" maxlength="80" name="Company" class="form-control textbox">
                                                </div>
                                              </div>
                                               ...
                                               <div class="form-group row">
                                                <label class="col-sm-4 col-form-label pr-0">Comments</label>
                                                <div class="col-sm-8">
                                                    <input type="text" maxlength="80" name="Company" class="form-control textbox">
                                                </div>
                                              </div>
                                               ...
                                               <div class="form-group row">
                                                <label class="col-sm-4 col-form-label pr-0"></label>
                                                <div class="col-sm-8">
                                              ...
                                              <!--  <div class="col-sm-8">-->
                                              <!--    <textarea name="LEADCF2" maxlength="2000" id="pageLocation">aries.in.net&nbsp;</textarea>-->
                                              <!--  </div>-->
                                              <!--</div>-->
