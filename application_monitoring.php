...
<body>
   ...
   <?php include('include/header.php'); ?>
    ...
    <!-- ##### Hero Area Start ##### -->
                ...
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            ...
                            <h3 class="text-dark heading pb-2">Application Monitoring & Performance</h3>
        ...
        <!--        <li class="breadcrumb-item">Application-->
                 ...
                 <div class="row">
                    <div class="col-md-9">
                        <div class="row p-3" style="border-top: 2px dotted #80808059;">
                           <div class="col-12">                              
                            <h6 style="color: #021058">APPLICATION MONITORING & PERFORMANCE</h6>
                            <div class="row">
                                <div class="col-md-7">
                                    <span class="text-info">Real User Monitoring</span>
                                    <ul>
                                        <li>* Monitor front-end performance</li>
                                        <li>* Ensure customer satisfaction</li>
                                        <li>* Performance reports, Alerts and Notifications</li>
                                    </ul><br>
                                    <span class="text-info">Application Monitoring</span>
                                    <ul>
                                        <li>* Visibility across your entire app</li>
                                        <li>* Troubleshoot and diagnose bottlenecks</li>
                                        <li>* Proactive notifications</li>
                                        <li>* Easy reporting</li>
                                    </ul><br>
                                    <span class="text-info">Server Monitoring</span>
                                    <ul>
                                        <li>* See your servers from the app perspective</li>
                                        <li>* Monitor server metrics</li>
                                        <li>* Fit your existing environment</li>
                                    </ul>
                                </div>
                                <div class="col-md-5">
                                    <img class="m-2" src="img/application_monitoring/real-user-monitoring.jpg">
                                    <img class="m-2" src="img/application_monitoring/application-monitoring.jpg">
                                    <img class="m-2" src="img/application_monitoring/server-monitoring.jpg">
                                </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="box">
                              ...
                              <div class="row p-2">
                                <div class=" col-md-8 col-lg-8 col-sm-8">
                                    <h6>Even more reasons to get started. Just pick a plan.</h6>
                                </div>
