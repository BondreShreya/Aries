...
<body>
   ...
   <?php include('include/header.php'); ?>
    ...
    <section>
        <div class="container">
             <h4 style="color: #021058">PLANS & PRICING</h4>
            <div class="row mt-5">
                        ...
                        <tr>
                         ...
                         <tr>
                           ...
                           <td>
                            ...
                            <img src="img\png\microsoft.png" title="Cloud OS" align="absmiddle"> </td>
                           <td>
                            <input type="radio" value="4110(Linux)" name="radio" checked="checked">
                            <img src="img\png\linux.png" title="Linux LOGO" align="absmiddle">
                            <input type="radio" value="4700(Windows)">
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12" style="height:295px;">
                                    <ul>
                                        <li class="border-bottom">Power Servers<span>Super micro-based servers starting from dual-core upto 8GB of RAM and dual HDDs. Best suited for hosting.</span></li>
                                        <li class="border-bottom">Virtualization Servers<span>Managed Virtualization Servers</span></li>
                                        <li class="border-bottom">Load Balancer, Cluster &amp; Firewall<span>Mirroring and failover service for traffic and load management on high-performance sites and server applications.</span></li>
                                    </ul>
                                </div>
